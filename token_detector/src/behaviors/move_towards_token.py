...
class MoveTowardsToken:
  ...
  def execute(self) -> None:
    ...
    rospy.logdebug(f'behavior: move_towards_token')
  ...
  def filter_unrecognized_tokens(self):
    ...
    for detected_token in self._raspicam_detector.tokens:
      if detected_token[1] < ignore_tokens_above_pixels_y:
        continue
      ...
      if not any_registered_token_within_distance(estimated_token_map_pose, self._killerrobot.tokens, 0.25): # dist 1 = 1m
